...
with open("/Users/areggi/Documents/REPOS/mycode/attemptlogin/keystone.common.wsgi") as kfile:
    ...
    for line in kfile:
        ...
        if "- - - - -] Authorization failed" in line:
            ...
            print("The is the ip address of the failed login attempt " + line.split(" ")[-1], end="")
            #print(line.spilt(" ")[-1])
